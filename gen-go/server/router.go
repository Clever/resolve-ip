...
import (
	...
	"github.com/Clever/resolve-ip/v4/gen-go/servertracing"
...
func newRouter(c Controller) *mux.Router {
	...
	router.Use(servertracing.MuxServerMiddleware("resolve-ip"))
	...
	router.Methods("GET").Path("/ip/{ip}").HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
