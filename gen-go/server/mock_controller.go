...
func (_m *MockController) LocationForIP(ctx context.Context, i *models.LocationForIPInput) (*models.IP, error) {
...
func (_mr *_MockControllerRecorder) LocationForIP(arg0, arg1 interface{}) *gomock.Call {
